    ...
    return(
        ...
        <div className="container">
            ...
            <div className="col-xs-12" style = {{padding : 15}}>
                    ...
                    <Typography className={myClass.text}>We are new in Software Industry and Build this app for the Users who feel problem while watch their favourite Series. As I noticed that some of the episodes are blocked or have bad Quality, We having Implemented our Best Scrappers which which will fetch out best quality servers for you in no time. If some Video wishes you to wait for playing it is therefore because our bots try their best to provide you Best Quality.</Typography>
                </div>
            </div>
            ...
            any suggestions or Query <br/> </Typography>
            ...
            <div className="col-xs-12" style = {{padding : 15}}>
                    ...
                    <Typography className={myClass.text}>We are remote For Now... Only COntact Us By Email</Typography>
                </div>
            </div>
            <br/>
